  ...
  return (
    <section id="Start" className="bg-cornsilk">
      <div className="flex md:flex-row flex-col">
        <div className="sm:w-1/2 w-full absolute h-100">
        <img src={flowerTop} alt="border" className="sm:pt-20 p-0"/>
        </div>
        <div className="sm:w-1/2 w-full absolute bottom-0">
        <img src={flowerBottom} alt="border"/>
        </div>
        <div className="bg-cornsilk h-screen md:w-1/2 w-full flex items-center sm:pt-32 pt-12">
