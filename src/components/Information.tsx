...
const Information: React.FC = () => {
  ...
  return (
    <section className="bg-cornsilk w-full py-12">
      ...
      <div className="flex-row justify-between px-5">
        <div className="text-center text-3xl">1:30 PM</div>
        <div className="flex-row">
          <div className="text-center text-xl">Shuttle arrives at venue</div>
        </div>
      </div>
      <div className="flex-row justify-between px-5">
        <div className="text-center text-3xl">10:15 PM</div>
        <div className="flex-row">
          <div className="text-center text-xl">
            Shuttle returns to venue for pick up
          </div>
        </div>
      </div>
      <div className="flex-row justify-between px-5">
        <div className="text-center text-3xl">10:30 PM</div>
        <div className="flex-row">
          <div className="text-center text-xl">
